...
try {
    Write-Output "[INFO] Starting LabLock Windows User-specific (HKCU) policy deployment..."
    ...
    # If you are deploying a packed .crx, uncomment the two lines below:
    ...
    Write-Output "[OK] LabLock user policies applied successfully to HKCU."
